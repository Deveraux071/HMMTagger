...
if __name__ == '__main__':
    ...
    print("Training on training1.txt, running tests on test1.txt. "
          "Output --> output1.txt")
    st = time.time()
    os.system("python3 tagger.py -d training5.txt training2.txt -t test3.txt -o output1.txt")
    et = time.time()
    elapsed = et - st
    ...
    with open("output1.txt", "r") as output_file, \
         open("solution3.txt", "r") as solution_file, \
        ...
        results_file.write("Elapsed time: " + str(elapsed) + " seconds")
